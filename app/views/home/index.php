...
<body class="bg-gradient-to-b from-blue-50 via-white to-gray-100 font-sans">
    ...
    <section id="home" class="relative bg-cover bg-center   text-white" style="background-image: url('../../public/images/bg.avif'); background-size: cover; /* Adapte l'image à l'écran */
  ...
  margin: 0;">
        ...
        <div class="container mx-auto px-6 lg:px-16 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg">
                    <img src="../../public/images/offres.png" alt="icon" class="mx-auto mb-4" style="width: 160px; height: 160px;">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg">
                    <img src="../../public/images/247.png" alt="icon" class="mx-auto mb-4" style="width: 160px; height: 160px;">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg">
                    <img src="../../public/images/flexible.png" alt="icon" class="mx-auto mb-4" style="width: 160px; height: 160px;">
    ...
    <section id="notre-public-cible" class="py-16 bg-blue-50">
        <div class="container mx-auto px-6 lg:px-16 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg">
                    <img src="../../public/images/etudiants.png" alt="Solo Travelers" class="mx-auto mb-4" style="width: 160px; height: 160px;">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg">
                    <img src="../../public/images/enseignants.png" alt="Couples" class="mx-auto mb-4" style="width: 160px; height: 160px;">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg">
                    <img src="../../public/images/freelancers.png" alt="Corporate Travelers" class="mx-auto mb-4" style="width: 160px; height: 160px;">
